...
`;let vt=class extends ct{render(){return G`<div style="padding:16px;color:#666">
      Visual editor not implemented yet — please use YAML mode.
    </div>`}};vt=e([dt(yt)],vt);const $t=W`
