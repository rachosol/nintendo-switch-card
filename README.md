...
- Freshness-aware console state using the telemetry heartbeat; it automatically
  changes to possible sleep after three minutes without telemetry, even if no
  further Home Assistant state update arrives.
